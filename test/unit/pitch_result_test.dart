...
void main() {
  group('PitchResult', () {
    test('silence sentinel has no pitch', () {
      expect(pitchResultSilence.hasPitch, isFalse);
      expect(pitchResultSilence.note, isNull);
      expect(pitchResultSilence.hasChord, isFalse);
    });
    ...
    test('result with valid pitch reports hasPitch = true', () {
      ...
      expect(r.note, equals(const Note(69)));
